...
public class StudentService implements StudentDao {
    ...
    public List<Integer> getGroupByStudentCount(int count) {
    ...
    @Override
    public List<StudentEntity> getStudentGraduateOneYear(String year) {
    ...
    public void getStudentsByStatement(List<StudentEntity> result, PreparedStatement preparedStatement) {
        ResultSet resultSet;
