...
public class StudentDaoImpl implements StudentDao {
    ...
    @Override
    public List<Integer> getGroupByStudentCount(long count) throws DaoException {
    ...
    @Override
    public Optional<StudentEntity> findById(long id) throws DaoException {
        try (Connection connection = ConnectionManager.get();
    ...
    public boolean update(StudentEntity studentEntity) throws DaoException {
        try (Connection connection = ConnectionManager.get();
            ...
            preparedStatement.setLong(3, studentEntity.getGroupId());
            preparedStatement.setLong(4, studentEntity.getId());
    ...
    public boolean create(StudentEntity studentEntity) throws DaoException {
        try (Connection connection = ConnectionManager.get();
            ...
            if (generatedKeys.next()) {
                studentEntity.setId(generatedKeys.getLong("id"));
            }
            return true;
        } catch (SQLException e) {
            throw new DaoException(e);
    ...
    public boolean delete(long id) throws DaoException {
        try (Connection connection = ConnectionManager.get();
            ...
            deleteRecordBookStatement.setLong(1, id);
